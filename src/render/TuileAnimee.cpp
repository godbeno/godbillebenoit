...
TuileAnimee::TuileAnimee(float x, float y, int id, float vitesse, Couche* couche,int TrueX,int TrueY, Scene* scene) : Tuile(x,y,id,TrueX,TrueY)
{
    ...
    switch(id)
    {
        ...
        case 5:
            ...
            break;
        case 6: 
            tuiles.push_back(new TuileStatique(x, y, 59, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 44, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 59, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 44, tx,TrueX,TrueY, scene));
            break;
        case 7: 
            tuiles.push_back(new TuileStatique(x, y, 61, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 62, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 61, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 62, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 46, tx,TrueX,TrueY, scene));
            break;
        case 8:
            tuiles.push_back(new TuileStatique(x, y, 65, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 48, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 65, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 48, tx,TrueX,TrueY, scene));
            break;
        case 9:
            tuiles.push_back(new TuileStatique(x, y, 67, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 50, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 67, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 50, tx,TrueX,TrueY, scene));
            break;
        case 10:
            tuiles.push_back(new TuileStatique(x, y, 69, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 52, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 69, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 52, tx,TrueX,TrueY, scene));
            break;
        case 11:
            tuiles.push_back(new TuileStatique(x, y, 71, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 54, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 71, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 54, tx,TrueX,TrueY, scene));
            break;
        case 12:
            tuiles.push_back(new TuileStatique(x, y, -1, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 45, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, -1, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 45, tx,TrueX,TrueY, scene));
            break;
        ...
        case 24:
            ...
            tuiles.push_back(new TuileStatique(x, y, 45, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, -1, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 56, tx,TrueX,TrueY, scene));
            break;
        case 25:
            tuiles.push_back(new TuileStatique(x, y, -1, tx,TrueX,TrueY, scene));
            tuiles.push_back(new TuileStatique(x, y, 47, tx,TrueX,TrueY, scene));
